/****************************************************************************
** Meta object code from reading C++ file 'my_class.hpp'
**
...
#error "The header file 'my_class.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 31, 6)
    ...
    "MyClass\0valueChanged\0\0setValue\0newVal\0"
};
...
void MyClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyClass::valueChanged)) {
                *result = 0;
            }
        }
    }
