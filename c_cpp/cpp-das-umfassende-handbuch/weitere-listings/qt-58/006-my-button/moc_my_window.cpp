/****************************************************************************
** Meta object code from reading C++ file 'my_window.hpp'
**
...
#error "The header file 'my_window.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 23, 2)
    ...
    "MyWindow\0myMessageBox\0\0id\0"
};
...
void MyWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->myMessageBox((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
